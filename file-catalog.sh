...
#export META_FORBIDDEN_FIELDS_CREATION=${META_FORBIDDEN_FIELDS_CREATION:=""}
#export META_FORBIDDEN_FIELDS_UPDATE=${META_FORBIDDEN_FIELDS_UPDATE:=""}
#export META_MANDATORY_FIELDS=${META_MANDATORY_FIELDS:=""}
